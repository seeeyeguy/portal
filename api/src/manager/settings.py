...
MIDDLEWARE = [
    ...
    "manager.middleware.MultiDatabaseRequestUserMiddleware",
...
CRONJOBS = [
    ...
    # Description: Communicate with external database to add new `Program`
    #   entries data.
    # Execution time: Everyday at 1:00 AM.
    (
        "0 1 * * *",
    ...
    #   entries data.
    # Execution time: Everyday every four hours starting at 0:00 (midnight).
    (
        "0 */4 * * *",
