...
from directory.controllers.Resource.tests.Resource.query.search.default import (
...
class TestSearchDefault(TestCaseUtility):
    ...
    fixtures: List[str] = [
        ...
        "directory/controllers/Resource/tests/Resource/query/search/default/fixtures/resources.json",
        "directory/controllers/Resource/tests/Resource/query/search/default/fixtures/requests.json",
        "directory/controllers/Resource/tests/Resource/query/search/default/fixtures/visits.json",
        "directory/controllers/Resource/tests/Resource/query/search/default/fixtures/favorites.json",
    ]
    ...
    def test_search_default_failure_empty_params(self) -> None:
        """Fail Case: Attempt to make a search with no parameters."""

        with pytest.raises(DirectoryError):
            _ = ResourceSearch.search(params={})  # type: ignore

    def test_search_default_failure_incorrect_parameter_value_type(self) -> None:
