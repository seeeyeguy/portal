...
from directory.controllers.Resource.tests.Resource.query.search import arguments
from directory.controllers.Resource.tests.Resource.query.search.functree import (
    arguments as search_functree_arguments,
)
from directory.controllers.Resource.tests.Resource.query.search.helper import (
    TestCaseUtility,
)
from directory.exceptions import DirectoryError


class TestSearchFunctreeNonSerialized(TestCaseUtility):
    """
    ...
    fixtures: List[str] = [
        ...
        "directory/controllers/Resource/tests/Resource/query/search/functree/fixtures/resources.json",
        "directory/controllers/Resource/tests/Resource/query/search/functree/fixtures/requests.json",
        "directory/controllers/Resource/tests/Resource/query/search/functree/fixtures/visits.json",
        "directory/controllers/Resource/tests/Resource/query/search/functree/fixtures/favorites.json",
    ]
    ...
    def test_search_functree_non_serialized_failure_empty_params(self) -> None:
        """Fail Case: Attempt to make a search with no parameters."""

        with pytest.raises(DirectoryError):
            _ = ResourceSearch.search(params={})  # type: ignore

    def test_search_functree_non_serialized_failure_incorrect_parameter_value_type(
        self,
    ) -> None:
