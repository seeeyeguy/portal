...
class TestSearchFunctreeSerialized(TestCaseUtility):
    """
    ...
    def test_search_functree_serialized_failure_empty_params(self) -> None:
        """Fail Case: Attempt to make a search with no parameters."""

        with pytest.raises(DirectoryError):
            _ = ResourceSearch.search(params={})  # type: ignore

    def test_search_functree_serialized_failure_incorrect_parameter_value_type(
        self,
    ) -> None:
